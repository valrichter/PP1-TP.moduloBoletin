...
const sendMailDirectivoPromedio = async ({email,idInstitucion, idMateria, idNivel, idGrado, anio}) => {
    try {
          ...
          attachments: [
            {
              ...
              path: __dirname + `/pdf-directivo-promedio/pdfs/boletin-directivo-promedio.pdf`,
            },
          ],
            from: "Boletín de notas informativas", // sender address
            to: email, // list of receivers
            subject: "Boletín Directivo Promedio", // Subject line
